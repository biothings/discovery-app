    ...
    $.ajax({url: "/user", success: function(result){
        ...
        if (result.login){
            if (result.avatar_url){
              ...
              html += "<li class='nav-item'><a class='nav-link' id='navPhotoLink' href='./dashboard'>"+result.login+" <img id='navPhoto' class='userImage' src='"+result.avatar_url+"' alt='user photo'></a></li>";
          }
