...
!(function (e, t) {
    ...
    (s.prototype.adjustTableSize = function () {
      ...
      if ("virtual" === this.renderMode) {
        ...
        this.fixedHeight
          ...
          : ((this.element.style.height = ""),
            (this.element.style.height =
              Math.floor(this.table.element.clientHeight) - o + "px"),
            (this.element.scrollTop = this.scrollTop)),
          (this.height = this.element.clientHeight),
          (this.vDomWindowBuffer =
            this.table.options.virtualDomBuffer || this.height),
          this.fixedHeight ||
            Math.floor(t) == Math.floor(this.element.clientHeight) ||
    ...
    (a.prototype.initializeRow = function (e) {
      if ("group" !== e.type) {
        ...
        for (var t = this.leftCol; t <= this.rightCol; t++) {
          ...
          if (o.visible) {
            var i = e.getCell(o);
            e.element.appendChild(i.getElement()), i.cellRendered();
          }
        }
      }
    }),
  ...
  (l.prototype.createElement = function () {
    ...
    (l.prototype.updateData = function (e) {
      var t,
        o = this,
        i = h.prototype.helpers.elVisible(this.element),
        n = {};
      return new Promise(function (s, a) {
    ...
    (l.prototype.wipe = function () {
      for (this.detatchModules(), this.deleteCells(); this.element.firstChild; )
        this.element.removeChild(this.element.firstChild);
      (this.element = !1),
        (this.modules = {}),
        this.element.parentNode &&
  ...
  (u.prototype.build = function () {
    ...
    (u.prototype.getElement = function () {
      return (
        this.loaded || ((this.loaded = !0), this.layoutElement()), this.element
      );
    }),
  ...
  (h.prototype.defaultOptions = {
    ...
    (h.prototype._buildElement = function () {
      ...
      if (
        ...
        i.persistence &&
          this.modExists("persistence", !0) &&
          o.persistence.config.columns &&
          (i.columns = o.persistence.load("columns", i.columns)),
      ...
      fitColumns: function (e) {
        ...
        function o(e, i, n, s) {
          ...
          return (
            ...
            l.length
              ? (l.forEach(function (e) {
                  (c += s ? e.width - e.column.minWidth : e.column.minWidth),
      ...
      return (
        e &&
          ...
          ((t.method && "get" != t.method.toLowerCase()) ||
            ((t.method = "get"),
            (e += (e.includes("?") ? "&" : "?") + this.serializeParams(o)))),
        e
      );
    }),
      ...
      return (
        !1 !== o.children &&
          ...
          this.table.modExists("sort") &&
            ...
            this.table.modules.sort.sort(i),
          i.forEach(function (e) {
            n.push(e),
  ...
  (R.prototype.initializeColumn = function (e) {
    ...
    (R.prototype.getCurrentCell = function () {
      return !!this.currentCell && this.currentCell.getComponent();
    }),
    (R.prototype.clearEditor = function (e) {
      var t,
        o = this.currentCell;
    ...
    (R.prototype.bindEditor = function (e) {
      var t = this,
        o = e.getElement();
    ...
    (R.prototype.edit = function (e, t, o) {
      function i(t) {
        if (c.currentCell === e) {
          var o = !0;
          return (
    ...
    (R.prototype.maskInput = function (e, t) {
      function o(t) {
        var r = i[t];
        void 0 !== r &&
          r !== a &&
    ...
    (R.prototype.getEditedCells = function () {
      var e = [];
      return (
    ...
    (R.prototype.clearEdited = function (e) {
      var t;
      e.modules.edit &&
    ...
    (R.prototype.editors = {
      ...
      select: function (e, t, o, i, n) {
        function s(t) {
          ...
          return (
            (o = t
              ? C.table.columnManager.getColumnByField(t)
              ...
              if (
                ...
                t.group
                  ...
                  : (o.classList.add("tabulator-edit-select-list-item"),
                    ...
                    P.indexOf(t) > -1 && o.classList.add("active")),
        ...
        function l(e, t) {
          !k && S && S.element && S.element.classList.remove("active"),
            S && S.element && S.element.classList.remove("focused"),
            (S = e),
            e.element &&
        ...
        function c(e) {
          -1 == P.indexOf(e) && (P.push(e), l(e, !0)), f();
        }
        function u(e) {
          var t = P[e];
          e > -1 &&
            (P.splice(e, 1), t.element && t.element.classList.remove("active"));
        }
        function d(e) {
          e || (e = S);
          var t = P.indexOf(e);
          t > -1 ? u(t) : (!0 !== k && P.length >= k && u(0), c(e)), f();
        }
        function p(e) {
          y(),
            e || (e = S),
        ...
        function g() {
          for (var e = P.length, t = 0; t < e; t++) u(0);
        }
        function b() {
          y(), i();
        }
        function v() {
          if (((P = []), !D.parentNode)) {
            ...
            (D.style.minWidth = R.offsetWidth + "px"),
              (D.style.top = e.top + R.offsetHeight + "px"),
          ...
          for (var F in n.elementAttributes)
            "+" == F.charAt(0)
              ? ((F = F.slice(1)),
                T.setAttribute(
                  F,
                  T.getAttribute(F) + n.elementAttributes["+" + F]
                ))
              : T.setAttribute(F, n.elementAttributes[F]);
        return (
          (T.value = void 0 !== x || null === x ? x : ""),
          ...
          T.addEventListener("keydown", function (e) {
            ...
            switch (e.keyCode) {
              ...
              case 40:
                (t = z.indexOf(S)),
                  ("editor" == M || ("hybrid" == M && t < z.length - 1)) &&
                    (e.stopImmediatePropagation(),
                    e.stopPropagation(),
                    e.preventDefault(),
                    t < z.length - 1 &&
                      (-1 == t ? l(z[0], !k) : l(z[t + 1], !k)));
                break;
              case 37:
              case 39:
                e.stopImmediatePropagation(),
      ...
      autocomplete: function (e, t, o, i, n) {
        ...
        function m() {
          b(),
            k
              ? R !== k.value
                ? ((R = k.value), (L.value = k.title), o(k.value))
                : i()
              : n.freetext
              ? ((R = L.value), o(L.value))
        ...
        function f() {
          if (!T.parentNode) {
            ...
            (T.style.minWidth = C.offsetWidth + "px"),
              (T.style.top = e.top + C.offsetHeight + "px"),
        ...
        return (
          ...
          L.addEventListener("keydown", function (e) {
            ...
            switch (e.keyCode) {
              ...
              case 40:
                (t = D.indexOf(k)),
                  ("editor" == x || ("hybrid" == x && t < D.length - 1)) &&
                    (e.stopImmediatePropagation(),
                    e.stopPropagation(),
                    e.preventDefault(),
                    t < D.length - 1 && g(-1 == t ? D[0] : D[t + 1]));
                break;
              case 37:
              case 39:
                e.stopImmediatePropagation(), e.stopPropagation();
      ...
      progress: function (e, t, o, i, n) {
        function s() {
          ...
          o(e),
            l.setAttribute("aria-valuenow", e),
    ...
    h.prototype.registerModule("edit", R);
    ...
    (L.prototype.bodyToExportRows = function (e) {
      ...
      return (
        ...
        e.forEach(function (e, n) {
          ...
          i.push(new x(e.type, a, e.getComponent(), r));
        }),
        i
      );
    }),
  ...
  (T.prototype.initializeColumn = function (e, t) {
    function o(t) {
      var o,
        a =
    ...
    (T.prototype.generateHeaderFilterElement = function (e, t, o) {
      function i() {}
      var n,
        s,
        a,
    ...
    (T.prototype.hideHeaderFilterElements = function () {
    ...
    (T.prototype.showHeaderFilterElements = function () {
      this.headerFilterColumns.forEach(function (e) {
        e.modules.filter &&
          e.modules.filter.headerElement &&
    ...
    (T.prototype.setHeaderFilterFocus = function (e) {
    ...
    (T.prototype.getHeaderFilterValue = function (e) {
    ...
    (T.prototype.setHeaderFilterValue = function (e, t) {
      e &&
        (e.modules.filter && e.modules.filter.headerElement
    ...
    (T.prototype.reloadHeaderFilter = function (e) {
      e &&
        (e.modules.filter && e.modules.filter.headerElement
    ...
    (T.prototype.hasChanged = function () {
      var e = this.changed;
      return (this.changed = !1), e;
    }),
    (T.prototype.setFilter = function (e, t, o, i) {
      var n = this;
      (n.filterList = []),
        Array.isArray(e) || (e = [{ field: e, type: t, value: o, params: i }]),
        n.addFilter(e);
    }),
    (T.prototype.addFilter = function (e, t, o, i) {
      var n = this;
      Array.isArray(e) || (e = [{ field: e, type: t, value: o, params: i }]),
        e.forEach(function (e) {
    ...
    (T.prototype.findFilter = function (e) {
      var t,
        o = this;
    ...
    (T.prototype.findSubFilters = function (e) {
      var t = this,
        o = [];
      return (
        e.forEach(function (e) {
    ...
    (T.prototype.getFilters = function (e, t) {
      var o = [];
      return (
    ...
    (T.prototype.filtersToArray = function (e, t) {
      var o = this,
        i = [];
      return (
        e.forEach(function (e) {
    ...
    (T.prototype.getHeaderFilters = function () {
      var e = [];
    ...
    (T.prototype.removeFilter = function (e, t, o) {
      var i = this;
    ...
    (T.prototype.clearFilter = function (e) {
      (this.filterList = []),
    ...
    (T.prototype.filterRow = function (e, t) {
      var o = this,
        i = !0,
        n = e.getData();
    ...
    (T.prototype.filterRecurse = function (e, t) {
      var o = this,
        i = !1;
      return (
        Array.isArray(e)
    ...
    h.prototype.registerModule("filter", T);
  var D = function (e) {
    this.table = e;
  };
  (D.prototype.initializeColumn = function (e) {
    ...
    (D.prototype.formatValue = function (e) {
      function t(t) {
    ...
    (D.prototype.formatExportValue = function (e, t) {
      var o,
  ...
  (N.prototype.initializeColumnHeader = function (e) {
    ...
    e.definition.headerContextMenu &&
      ...
      e.definition.headerMenu &&
        ...
        t.addEventListener("click", function (t) {
          var i =
            "function" == typeof e.definition.headerMenu
              ? e.definition.headerMenu(e.getComponent(), t)
              : e.definition.headerMenu;
    ...
    (N.prototype.LoadMenuEvent = function (e, t, o) {
      (t = "function" == typeof t ? t(e.getComponent(), o) : t),
        this.loadMenu(o, e, t);
    }),
    ...
    (N.prototype.loadMenu = function (e, t, o) {
      ...
      if ((s || e.preventDefault(), o && o.length)) {
        ...
        this.hideMenu(),
          ...
          (this.menuEl.style.top = (s ? e.touches[0].pageY : e.pageY) + "px"),
          (this.menuEl.style.left = (s ? e.touches[0].pageX : e.pageX) + "px"),
          setTimeout(function () {
            i.table.rowManager.element.addEventListener("scroll", i.blurEvent),
              document.body.addEventListener("click", i.blurEvent),
              document.body.addEventListener("contextmenu", i.blurEvent),
              document.body.addEventListener("keydown", i.escEvent);
          }, 100),
          document.body.appendChild(this.menuEl),
          e.pageX + this.menuEl.offsetWidth >= document.body.offsetWidth &&
            ((this.menuEl.style.left = ""),
            (this.menuEl.style.right =
              document.body.offsetWidth - e.pageX + "px")),
          e.pageY + this.menuEl.offsetHeight >= n &&
            ((this.menuEl.style.top = ""),
            (this.menuEl.style.bottom = n - e.pageY + "px"));
      }
    }),
  ...
  (Y.prototype.initialize = function (e) {
    ...
    (Y.prototype.clearBindings = function (e) {
    ...
    h.prototype.registerModule("resizeTable", Y);
  var q = function (e) {
    (this.table = e),
      (this.columns = []),
      (this.hiddenColumns = []),
  ...
  (q.prototype.initialize = function () {
    ...
    (q.prototype.initializeColumn = function (e) {
    ...
    (q.prototype.showColumn = function (e) {
      var t;
      e.show(!1, !0),
    ...
    (q.prototype.generateCollapsedContent = function () {
      var e = this;
      this.table.rowManager.getDisplayRows().forEach(function (t) {
        e.generateCollapsedRowContent(t);
      });
    }),
    (q.prototype.generateCollapsedRowContent = function (e) {
      var t, o;
    ...
    (q.prototype.generateCollapsedRowData = function (e) {
      var t,
        o = this,
        i = e.getData(),
        n = [];
    ...
    (q.prototype.formatCollapsedData = function (e) {
      ...
      return (
        e.forEach(function (e) {
          ...
          e.value instanceof Node &&
            (t.appendChild(e.value), (e.value = t.innerHTML)),
            (o +=
              "<tr><td><strong>" +
              e.title +
              "</strong></td><td>" +
    ...
    h.prototype.registerModule("responsiveLayout", q);
  var K = function (e) {
    (this.table = e),
      (this.selecting = !1),
    ...
    (J.prototype.sorters = {
      number: function (e, t, o, i, n, s, a) {
        var r = a.alignEmptyValues,
          ...
          u = 0;
        if (
          ((e = parseFloat(String(e).split(c).join("").split(l).join("."))),
          (t = parseFloat(String(t).split(c).join("").split(l).join("."))),
          isNaN(e))
        )
          u = isNaN(t) ? 0 : -1;
        else {
