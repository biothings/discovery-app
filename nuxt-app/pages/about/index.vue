    ...
    <div class="container">
      ...
      <div class="mt-5 mb-5">
        ...
        <p class="text-muted" style="font-size: 1.4em">
          ...
          to expose their dataset metadata to these data portals. This project
          is targeted to streamline and minimize the efforts from data providers
      ...
      <div class="jumbotron alert-secondary">
        ...
        <p>
          For more information on how to cite the Data Discovery Engine
          <NuxtLink to="/how-to-cite">click here</NuxtLink>.
        </p>
      </div>
