...
export const useSchemaRegistryStore = defineStore("schemaRegistryStore", {
  state: () => ({
    maxComparisons: 4,
    maxReached: false,
    compareItems: [],
  ...
  actions: {
    ...
    removeItem(payload) {
      let item = payload["item"];
      let i = "";
      this.compareItems.find((n, index) => {
        if (n["name"] == item["name"]) {
          i = index;
        }
      });
    ...
    compareAll() {
      ...
      this.compareResults = finalResutls;
      // show modal
      ...
      var table = new Tabulator("#example-table", {
        ...
        data: this.compareResults, //assign data to table
